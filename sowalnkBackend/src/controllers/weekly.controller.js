...
const weeklyTaskController = {
  createTask: asyncHandler(async (req, res) => {
    try {
      ...
      const existedData = await weeklyTask.findOne({
  ...
  getAllTasks: asyncHandler(async (req, res) => {
    try {
      ...
      const tasks = await weeklyTask.find({ user: userId });
  ...
  toggleTaskCompletion: asyncHandler(async (req, res) => {
    ...
    const task = await weeklyTask.findOne({ _id: id, user: userId });
  ...
  deleteTask: asyncHandler(async (req, res) => {
    ...
    const deletedTask = await weeklyTask.findOneAndDelete({
      _id: id,
      user: userId,
    });
